package cn.bsd.learn.autoreplyrobot.utils;
...
public class HttpUtils {
    private static String PATH = "http://www.tuling123.com/openapi/api";
...
//            System.out.println(buffer.toString());
    ...
    public static String autoReply(final String content) {
        if (content == null) {
            return null;
        }
        Map<String, String> map = new HashMap<>();
        map.put("key", "这里填自己的key");
        map.put("info", content);
        map.put("userid", "这里填自己的id");
